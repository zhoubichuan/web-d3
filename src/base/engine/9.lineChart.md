...
export default {
  ...
  methods: {
    init() {
      ...
      d3.csv("/basicLineChart.csv", function (d) {
        return {
          date: d.date,
          money: +d.money,
        };
...
export default {
  ...
  methods: {
    init() {
      ...
      d3.csv("/parallelLineChart.csv", function (d) {
        return {
          name: d.name,
          math: +d.math,
          chinese: +d.chinese,
...
export default {
  ...
  methods: {
    init() {
      ...
      d3.csv("/smoothLineChart.csv", function (d) {
        return {
          date: d.date,
          money: +d.money,
        };
...
export default {
  ...
  methods: {
    init() {
      ...
      d3.csv("/stackedAreaChart.csv", function (d) {
        return {
          date: d.date,
          total: +d.total,
          food: +d.food,
